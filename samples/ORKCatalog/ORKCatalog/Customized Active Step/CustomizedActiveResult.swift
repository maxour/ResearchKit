...
public class CustomizedActiveResult: ORKResult {
    ...
    override public func isEqual(_ object: Any?) -> Bool {
        ...
        if let castObject = object as? CustomizedActiveResult {
            return (isParentSame &&
    ...
    override public func copy(with zone: NSZone? = nil) -> Any {
        if let result = super.copy(with: zone) as? CustomizedActiveResult {
