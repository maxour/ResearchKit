...
public class CustomizedActiveStepViewController: ORKActiveStepViewController {
    
    private let stroopContentView = CustomizedActiveContentView()
    ...
    private func stroopStep() -> CustomizedActiveStep {
        return step as! CustomizedActiveStep
    }
    ...
    private func createResult(color: String, withText text: String, withColorSelected colorSelected: String) {
        let stroopResult = CustomizedActiveResult(identifier: (step!.identifier))
